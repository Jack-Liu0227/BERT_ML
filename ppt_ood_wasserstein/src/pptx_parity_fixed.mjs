...
const bytes = await readFile('output/ood_wasserstein_formula_slide_formula_fixed.pptx');
...
await writeFile('scratch/ood_wasserstein_formula_slide_formula_fixed.pptx_rerender.png', Buffer.from(await blob.arrayBuffer()));
