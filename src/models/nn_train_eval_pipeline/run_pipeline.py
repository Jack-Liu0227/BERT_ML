...
# # To run an Optuna hyperparameter search:
# python -m src.models.nn_train_eval_pipeline.run_pipeline `
#     --data_file "Features/Ti_alloys/Xue/Mechanical/all_features/features.csv" `
#     --result_dir "output/results/Ti_alloys/Xue/Mechanical/NN_opt" `
...
# python -m src.models.nn_train_eval_pipeline.run_pipeline `
#     --data_file "Features/Ti_alloys/Xue/ID/all_features/features_with_id.csv" `
#     --result_dir "output/results/Ti_alloys/Xue/ID/NN_opt" `
#     --target_columns "UTS(MPa)" "El(%)" `
#     --cross_validate `
#     --num_folds 9 `
#     --epochs 200 `
...
# python -m src.models.nn_train_eval_pipeline.run_pipeline `
#     --data_file "Features/HEA_data/yasir_data/all_features/features.csv" `
#     --result_dir "output/results/HEA_data/yasir_data/NN_opt" `
...
# python -m src.models.nn_train_eval_pipeline.run_pipeline `
#     --data_file "Features\HEA_data\yasir_data\ID\all_features\features_with_id.csv" `
#     --result_dir "output/results/HEA_data/yasir_data/ID/NN_opt" `
#     --target_columns "YS(MPa)" "UTS(MPa)" "El(%)" `
#     --cross_validate `
#     --num_folds 9 `
#     --epochs 200 `
...
# python -m src.models.nn_train_eval_pipeline.run_pipeline `
#     --data_file "Features\Al_Alloys\USTB_new\all_features_withID\features_with_id.csv" `
#     --result_dir "output\results\Al_alloys\USTB_new\ID\NN_opt" `
...
# python -m src.models.nn_train_eval_pipeline.run_pipeline `
#     --data_file "Features/HEA_data/yasir_data_half/ID/all_features/features_with_id.csv" `
#     --result_dir "output/results/HEA_data/yasir_data_half/ID/NN_opt" `
#     --target_columns "YS(MPa)" "UTS(MPa)" "El(%)" `
#     --cross_validate `
#     --num_folds 9 `
#     --epochs 200 `
...
# python -m src.models.nn_train_eval_pipeline.run_pipeline `
#     --data_file "Features/Nb_Alloys/Nb_cleandata/ID/all_features/features_with_id.csv" `
#     --result_dir "output/results/Nb_Alloys/Nb_cleandata/ID/NN_opt/noTem" `
#     --target_columns "YS(MPa)" "UTS(MPa)" "El(%)" `
#     --cross_validate `
#     --num_folds 9 `
#     --epochs 200 `
...
# python -m src.models.nn_train_eval_pipeline.run_pipeline `
#     --data_file "Features/Nb_Alloys/Nb_cleandata/ID/all_features/features_with_id.csv" `
#     --result_dir "output/results/Nb_Alloys/Nb_cleandata/ID/NN_opt/withTem" `
#     --target_columns "YS(MPa)" "UTS(MPa)" "El(%)" `
#     --cross_validate `
#     --num_folds 9 `
#     --epochs 200 `
...
# python -m src.models.nn_train_eval_pipeline.run_pipeline `
#     --data_file "Features\\Nb_Alloys\\Harbin\\HTC\\all_features_withID\features_with_id.csv" `
#     --result_dir "output/results/Nb_alloys/Harbin/HTC/NN_opt" `
...
# python -m src.models.nn_train_eval_pipeline.run_pipeline \
#     --data_file "Features\Nb_alloys\Harbin\KQ\all_features_withID\features_with_id.csv" \
#     --result_dir "output/results/Nb_alloys/Harbin/KQ/NN_opt" \
...
#     --result_dir "output\results\Steel\USTB_steel\NN_opt" `
