...
DEFAULT_TRIPTYCH_CONFIG: dict[str, Any] = {
    ...
    "figure": {
        ...
        "summary_title": "Mean trial-level MAE summary",
        "baseline_title": "MAE vs Traditional-best baseline (%)",
        "rank_title": "Per-method rank (by mean trial-level MAE)",
